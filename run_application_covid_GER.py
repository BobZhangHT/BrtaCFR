...
def main():
    ...
    # Final plot styling
    ax.set_title(f'Case Fatality Rate Estimators for {COUNTRY}\nData: Johns Hopkins CSSE', fontsize=16)
    ...
    ax1.set_title(f"COVID-19 ({COUNTRY}) — Daily Cases and Deaths\nData: Johns Hopkins CSSE", fontsize=16)
    ...
    ax1.set_title(f"COVID-19 ({COUNTRY}) — 7-day Moving Averages\nData: Johns Hopkins CSSE", fontsize=16)
